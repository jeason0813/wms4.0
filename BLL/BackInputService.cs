        ...
        public string SaveData(BackInput bill)
        {
            ...
            else
            {
                ...
                foreach (Record record in bill.Record)
                {
                    ...
                    record.InOrOut = 0;
                    record.MainTableType = "BackInput";
